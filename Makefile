...
build-templates:
	handlebars templates -f gen/templates.js -k if -k unless -k with -k round -k roundWinp -k matchup -k face -k new_window -k skills_block -k currency -k numberWithCommas -o
