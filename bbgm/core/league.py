...
def delete(league_id):
    ...
    tables = ['active_playoff_series', 'game_attributes', 'league_conferences', 'league_divisions', 'player_attributes', 'player_ratings', 'player_stats', 'released_players_salaries', 'team_attributes', 'team_stats']
    for table in tables:
