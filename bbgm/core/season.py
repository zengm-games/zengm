...
def new_phase(phase):
    ...
    if phase == c.PHASE_PRESEASON:
        ...
        for row in r.fetchall():
            g.dbex('INSERT INTO player_ratings (pid, season, ovr, hgt, stre, spd, jmp, endu, ins, dnk, ft, fg, tp, blk, stl, drb, pss, reb, pot) VALUES (:pid, :season, :ovr, :hgt, :stre, :spd, :jmp, :end, :ins, :dnk, :ft, :fg, :tp, :blk, :stl, :drb, :pss, :reb, :pot)', **row)
