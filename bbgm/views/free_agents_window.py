...
class FreeAgentsWindow:
    ...
    def on_button_free_agents_sign_clicked(self, button, data=None):
        ...
        if treeiter:
            ...
            if num_players_on_roster >= 15:
                dialog = Gtk.MessageDialog(None, 0, Gtk.MessageType.WARNING, Gtk.ButtonsType.CLOSE, ('Your roster is full. '
                ...
                if response != int(Gtk.ResponseType.CLOSE) and response != int(Gtk.ResponseType.DELETE_EVENT):
    ...
    def build_free_agents(self):
        ...
        liststore.set_sort_column_id(4, Gtk.SortType.DESCENDING)
