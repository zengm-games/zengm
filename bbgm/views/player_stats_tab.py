...
class PlayerStatsTab:
    ...
    def build(self):
        ...
        self.mw.notebook.insert_page(self.vbox6, Gtk.Label(label='Player Stats'), self.mw.pages['player_stats'])

        self.built = True

    def update(self):
        if common.DEBUG:
            print 'update player_stats_tab'
