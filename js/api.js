 ...
 */
define(["db", "views", "ui", "core/draft", "core/game", "core/player", "core/season", "core/trade", "lib/davis", "lib/jquery", "lib/underscore", "util/lock"], function (db, views, ui, draft, game, player, season, trade, Davis, $, _, lock) {
    "use strict";
