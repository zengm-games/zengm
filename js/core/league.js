                ...
                db.setGameAttributes(gameAttributes, function () {
                    ...
                    for (i = 0; i < teams.length; i++) {
                        teamStore.add({
                            ...
                            seasons: [{season: g.startingSeason, gp: 0, att: 0, cash: 10000, won: 0, lost: 0, wonHome: 0, lostHome: 0, wonAway: 0, lostAway: 0, wonDiv: 0, lostDiv: 0, wonConf: 0, lostConf: 0, lastTen: [], streak: 0, madePlayoffs: false, confChamps: false, leagueChamps: false, hype: Math.random(), pop: teams[i].pop, tvContractAmount: 0, tvContractExp: 0, merchRevenue: 0, sponsorRevenue: 0, ticketRevenue: 0, nationalTvRevenue: 0, localTvRevenue: 0, payrollEndOfSeason: -1, salaryPaid: 0, luxuryTaxPaid: 0, minTaxPaid: 0, otherPaid: 0}] // Things that only have one value per season
                        });
                    }
