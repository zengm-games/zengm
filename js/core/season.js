 ...
 */
define(["db", "ui", "core/contractNegotiation", "core/freeAgents", "core/player", "lib/underscore", "util/helpers", "util/random"], function (db, ui, contractNegotiation, freeAgents, player, _, helpers, random) {
    "use strict";
