			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				if ( iPushFeature == 1 && nTmp !== null )
				{
					...
					if (cOption === "t" ) {
						...
						if (nTmp.parentNode.classList.contains("table-responsive") || nTmp.parentNode.classList.contains("table-responsive-placeholder")) {
							nTmp.parentNode.classList.remove("table-responsive")
							nTmp.parentNode.classList.add("table-responsive-placeholder")
							var nTmpOld = nTmp;
