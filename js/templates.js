...
module.exports = {
    ...
    inbox: fs.readFileSync(__dirname + '/../templates/inbox.html', 'utf8'),
    ...
    schedule: fs.readFileSync(__dirname + '/../templates/schedule.html', 'utf8'),
    standings: fs.readFileSync(__dirname + '/../templates/standings.html', 'utf8'),
