...
function program4(depth0,data) {
  ...
  buffer += escapeExpression(stack1) + "/dist_team_stats\">View team stat distributions</a></p>";
  return buffer;});
