...
define(["globals", "lib/jquery", "lib/knockout", "util/eventLog"], function (g, $, ko, eventLog) {
    ...
    function getTeamsDefault() {
        ...
        teams = [
            ...
            {tid: 2, cid: 0, did: 0, region: "Boston", name: "Massacre || Three Party", abbrev: "BOS", pop: 4.4},
            {tid: 3, cid: 0, did: 1, region: "Chicago", name: "Fire || Improv", abbrev: "CHI", pop: 8.8},
            {tid: 4, cid: 0, did: 1, region: "Cincinnati", name: "Riots", abbrev: "CIN", pop: 1.6},
            {tid: 5, cid: 0, did: 1, region: "Cleveland", name: "Mistakes || Curses", abbrev: "CLE", pop: 1.9},
            ...
            {tid: 9, cid: 1, did: 3, region: "Houston", name: "Apollos || Lean", abbrev: "HOU", pop: 4.3},
            {tid: 10, cid: 1, did: 5, region: "Las Vegas", name: "Blue Chips", abbrev: "LV", pop: 1.7},
            {tid: 11, cid: 1, did: 5, region: "Los Angeles", name: "Smog || Sea Lions", abbrev: "LA", pop: 12.3},
            {tid: 12, cid: 1, did: 3, region: "Mexico City", name: "Diablos || Aztecs", abbrev: "MXC", pop: 19.4},
            {tid: 13, cid: 0, did: 2, region: "Miami", name: "Beach", abbrev: "MIA", pop: 5.4},
            {tid: 14, cid: 1, did: 4, region: "Minneapolis", name: "Millers", abbrev: "MIN", pop: 2.6},
            ...
            {tid: 18, cid: 1, did: 3, region: "Phoenix", name: "Deserts", abbrev: "PHO", pop: 3.4},
            {tid: 19, cid: 0, did: 1, region: "Pittsburgh", name: "Pierogies", abbrev: "PIT", pop: 1.8},
            ...
            {tid: 23, cid: 1, did: 5, region: "San Francisco", name: "Quakes || Venture Capitalists || Hippies", abbrev: "SF", pop: 3.4},
            {tid: 24, cid: 1, did: 4, region: "Seattle", name: "Symphony", abbrev: "SEA", pop: 3.0},
            {tid: 25, cid: 1, did: 3, region: "St. Louis", name: "Spirits", abbrev: "PHO", pop: 2.2},
            {tid: 26, cid: 0, did: 2, region: "Tampa", name: "Thunderstorms", abbrev: "TPA", pop: 2.2},
            {tid: 27, cid: 0, did: 0, region: "Toronto", name: "Cosmopolitans", abbrev: "TOR", pop: 6.3},
            {tid: 28, cid: 1, did: 4, region: "Vancouver", name: "Curlers || Whalers", abbrev: "VAN", pop: 2.3},
            {tid: 29, cid: 0, did: 2, region: "Washington", name: "Plumbers || Murder Capitals", abbrev: "WAS", pop: 4.2}
        ];
