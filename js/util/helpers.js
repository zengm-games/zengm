...
define(["globals", "lib/jquery", "lib/knockout", "util/eventLog"], function (g, $, ko, eventLog) {
    ...
    function getTeamsDefault() {
        ...
        teams = [
            ...
            {tid: 9, cid: 1, did: 3, region: "Houston", name: "Lean", abbrev: "HOU", pop: 4.3},
            {tid: 10, cid: 1, did: 5, region: "Las Vegas", name: "Blue Chips", abbrev: "LV", pop: 1.7},
            {tid: 11, cid: 1, did: 5, region: "Los Angeles", name: "Sea Lions", abbrev: "LA", pop: 12.3},
            ...
            {tid: 17, cid: 0, did: 0, region: "Philadelphia", name: "Cheese Steaks", abbrev: "PHI", pop: 5.4},
            ...
            {tid: 25, cid: 1, did: 4, region: "Seattle", name: "Mermen", abbrev: "SEA", pop: 3.0},
            ...
            {tid: 29, cid: 0, did: 2, region: "Washington", name: "Plumbers", abbrev: "WAS", pop: 4.2}
        ];
