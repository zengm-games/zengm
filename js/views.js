 ...
 */
define(["views/dashboard", "views/deleteLeague", "views/draft", "views/draftSummary", "views/editTeamInfo", "views/exportRosters", "views/fantasyDraft", "views/freeAgents", "views/gameLog", "views/hallOfFame", "views/history", "views/inbox", "views/leaders", "views/leagueDashboard", "views/leagueFinances", "views/manual", "views/message", "views/negotiation", "views/negotiationList", "views/newLeague", "views/newTeam", "views/player", "views/playerRatingDists", "views/playerRatings", "views/playerShotLocations", "views/playerStatDists", "views/playerStats", "views/playoffs", "views/roster", "views/schedule", "views/standings", "views/teamFinances", "views/teamHistory", "views/teamShotLocations", "views/teamStatDists", "views/teamStats", "views/trade", "views/tradingBlock"], function (dashboard, deleteLeague, draft, draftSummary, editTeamInfo, exportRosters, fantasyDraft, freeAgents, gameLog, hallOfFame, history, inbox, leaders, leagueDashboard, leagueFinances, manual, message, negotiation, negotiationList, newLeague, newTeam, player, playerRatingDists, playerRatings, playerShotLocations, playerStatDists, playerStats, playoffs, roster, schedule, standings, teamFinances, teamHistory, teamShotLocations, teamStatDists, teamStats, trade, tradingBlock) {
    "use strict";
