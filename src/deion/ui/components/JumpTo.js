	...
	return (
		<UncontrolledDropdown className="ml-auto">
			...
			<DropdownMenu>
				...
				<DropdownItem href={genUrl(["draft_history"], s)}>Draft</DropdownItem>
				<DropdownItem href={genUrl(["leaders"], s)}>Leaders</DropdownItem>
				<DropdownItem href={genUrl(["team_stats"], s)}>Team Stats</DropdownItem>
