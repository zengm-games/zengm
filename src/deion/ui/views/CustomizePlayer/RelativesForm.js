						...
						<div className="d-flex align-items-end mb-3" key={i}>
							<div className="mr-3">
								...
								<select
									...
									onChange={event => {
										this.handleRelativesChange(i, "type", event);
									}}
									value={type}
								>
							...
							<div className="mr-2">
								{i === 0 ? (
									<label>
										...
										<HelpPopover placement="bottom" title="Player ID number">
											...
											<p>
												To find a player ID number, go to the player page for
												that player and look at the end of the URL. For
												instance, if the URL is https://play.
												{process.env.SPORT}
								...
								<input
									...
									className="form-control"
									onChange={event => {
										this.handleRelativesChange(i, "pid", event);
									}}
									value={pid}
								/>
							</div>
