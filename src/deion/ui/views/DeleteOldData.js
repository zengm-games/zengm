				...
				<form onSubmit={this.handleSubmit}>
					...
					<div className="form-check">
						<label className="form-check-label">
							<input
								className="form-check-input"
								onChange={this.handleChanges.retiredPlayersUnnotable}
								type="checkbox"
							...
							<br />
							<i>
								Won't delete your past players or players who have won awards
							</i>
						</label>
					</div>
					<div className="form-check">
					...
					<div className="form-check">
						<label className="form-check-label">
							<input
								className="form-check-input"
								onChange={this.handleChanges.playerStatsUnnotable}
								type="checkbox"
					...
					<p className="alert alert-danger mt-3">
						...
						There's no going back! This can impact your players making the Hall
						of Fame and the completion of in-progress achievements!
					</p>
