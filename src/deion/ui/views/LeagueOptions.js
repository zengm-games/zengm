					...
					<div className="row">
						<div className="col-sm-3 col-6 form-group">
							...
							<select
								...
								onChange={this.handleChanges.autoDeleteOldBoxScores}
						...
						<div className="col-sm-3 col-6 form-group">
							<label>
								...
								<HelpPopover title="Stop On Injury Longer Than">
									This will stop game simulation if one of your players is
									injured for more than N games. In auto play mode (Tools > Auto
									Play Seasons), this has no effect.
								</HelpPopover>
							</label>
							<select
								className="form-control"
							...
							<div className="input-group mt-2">
								<input
									...
									onChange={this.handleChanges.stopOnInjuryGames}
						...
						<div className="col-sm-3 col-6 form-group">
							<label>
								...
								<HelpPopover placement="bottom" title="Difficulty">
									...
									<p>
										If you set the difficulty to Easy, you will not get credit
										for any <a href="/account">Achievements</a>. This persists
										even if you switch to a harder difficulty.
									</p>
								</HelpPopover>
							</label>
							<select
