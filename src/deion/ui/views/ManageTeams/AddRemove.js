...
const AddRemove = ({ dispatch, confs, divs }: Props) => {
    ...
    return (
        <div className="row">
            <div className="col-sm">
                <p>
                    After you add a team, it will become available to edit in
                    the form below. Created teams start with no players. You can
                    use God Mode to set up the roster, or start simulating and
                    the AI will sign free agents. There is not yet support for a
                    real expansion draft.
                </p>
            ...
            <div className="col-sm">
                ...
                <p>
                    <span className="text-danger">Please be careful!</span> This
                    will{" "}
