        ...
        return (
            <div>
                ...
                <p>
                    ...
                    breaks things. Please play until free agency and then you
                    can switch teams.
                </p>
            </div>
        );
    ...
    if (userTids.length === 1) {
        ...
        statusText = (
            <span>
                ...
                disable it, unselect all but one team or click the button below.
            </span>
        );
    } else {
        statusText = (
    ...
    return (
        <>
            ...
            <p>
                ...
                multiple teams. Why would you want to do this? A few reasons I
                can think of:
            </p>

            <ul>
                <li>
                    Live in-person multiplayer - two people sharing one computer
                    can play in the same league together
                </li>
                <li>
                ...
                <li>
                    Online multiplayer - if you want to run a league where you
                    are the commissioner and other people email you roster moves
                    to make manually, you don't want AI fucking things up
                </li>
            </ul>
            ...
            <p>
                ...
                ctrl+click (command+click on Mac) to select individual teams.
            </p>
