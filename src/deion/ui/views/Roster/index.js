	...
	clickable(props => {
		...
		return (
			<tr
				...
				data-pid={p.pid}
			>
				{editable ? <ReorderHandle i={i} isSorting={isSorting} /> : null}
									...
									<th title="Playing Time Modifier">
										...
										<HelpPopover placement="left" title="Playing Time Modifier">
											<p>
												...
												and stamina. If you want to influence his judgement,
												your options are:
											</p>
											<p>
									...
									<th>
										...
										<HelpPopover placement="left" title="Release Player">
											<p>
												...
												your team. You will still have to pay his salary (and
												have it count against the salary cap) until his contract
												expires (you can view your released players' contracts
												in your{" "}
											...
											<p>
												...
												season has not started yet, his contract is not
												guaranteed and you can release him for free.
											</p>
										</HelpPopover>
									</th>
								) : null}
