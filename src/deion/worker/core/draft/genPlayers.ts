...
const genPlayers = async (
	...
	for (const p of players) {
		await idb.cache.players.add(p); // Weird Flow type casing is because idb.cache.players.add will create the "pid" property, transforming PlayerWithoutPid to Player
		// $FlowFixMe
