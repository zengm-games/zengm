...
// These are achievements that are common across all sports. Sport-specific achievements go in the sport-specific folder, not deion.
...
const achievements: Achievement[] = [
    ...
    },
    {
        slug: "golden_oldies",
        name: "Golden Oldies",
        desc: `Win a title when your entire team is at least ${
            goldenOldiesCutoffs[0]
        } years old.`,
        category: "Team Composition",
        async check() {
    ...
    },
    {
        slug: "young_guns",
        name: "Young Guns",
        desc: `Win a title when your entire team is at most ${
            youngGunsCutoffs[0]
        } years old.`,
        category: "Team Composition",
        async check() {
