...
import { PlayerGameSim, PlayersOnField } from "./types"; // weightsBonus is not added to denominator, it just gives a bonus in situations e.g. with extra receivers or blockers beyond normal
