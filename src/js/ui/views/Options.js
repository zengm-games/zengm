...
class GodMode extends React.Component {
    constructor(props) {
        ...
        this.handleChanges = {
            ...
            stopOnInjuryGames: this.handleChange.bind(this, 'stopOnInjuryGames'),
        };
        ...
        return <div>
            ...
            <form onSubmit={this.handleFormSubmit}>
                <div className="row">
                    ...
                    <div className="col-sm-3 col-xs-6 form-group">
                        <label>Stop On Injury Longer Than <HelpPopover placement="right" title="Stop On Injury Longer Than">
                        ...
                        <select className="form-control" onChange={this.handleChanges.stopOnInjury} value={this.state.stopOnInjury}>
                            <option value="true">Enabled</option>
                            <option value="false">Disabled</option>
                        </select>
                        <div className="input-group" style={{marginTop: '0.5em'}}>
                            <input type="text" className="form-control" disabled={this.state.stopOnInjury === false || this.state.stopOnInjury === 'false'} onChange={this.handleChanges.stopOnInjuryGames} value={this.state.stopOnInjuryGames} /><span className="input-group-addon">Games</span>
                        </div>
                    </div>
                </div>
