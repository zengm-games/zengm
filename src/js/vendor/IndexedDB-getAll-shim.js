...
(function(window) {
    ...
    Event = function(type) {
        ...
        this.stopPropagation = function() {
            console.log(
                "stopPropagation not implemented in IndexedDB-getAll-shim",
            );
        };
        this.stopImmediatePropagation = function() {
            console.log(
                "stopImmediatePropagation not implemented in IndexedDB-getAll-shim",
            );
        };
        ...
        this.preventDefault = function() {
            console.log(
                "preventDefault not implemented in IndexedDB-getAll-shim",
            );
        };
    ...
    getAllFactory = function(type) {
        return function(key, count) {
            ...
            cursorRequest.onerror = function(event) {
                console.log(
                    "IndexedDB-getAll-shim error when getting data:",
                    event.target.error,
                );
