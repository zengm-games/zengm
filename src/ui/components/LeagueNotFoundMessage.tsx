			...
			<div className="row">
				<div className="col-md-6">
					...
					<div className="row">
						<div className="col-sm-6 col-md-12 col-lg-6">
							...
							<ol>
								<li>
									Should you re-sign a veteran player, or leave cap space open
								...
								<li>
									Should you trade away next season's draft pick for a player
									who can help you win now, or stockpile assets for the future?
								</li>
								<li>
						...
						<div className="col-sm-6 col-md-12 col-lg-6">
							...
							<p>
								{GAME_NAME} is completely 100% free. You can start as many
								leagues as you want and play as many seasons as you want. No
								limits.
							</p>
							<p>
				...
				<div className="col-md-6">
					...
					<p>
						...
						profile. This means that you can't play one league on multiple
						devices unless you export it (from the Tools menu) and then create a
						new league with that file. So first,{" "}
					...
					<p>
						...
						leagues are missing, the game data has probably been deleted. This
						can happen in places like schools and libraries that set browsers to
						automatically delete everything when they are closed. It also
						happens if you manually delete your browser data. For example, in
						Chrome, if you go to More tools &gt; Clear browsing data... &gt;
						Cookies and other site and plugin data, that will delete all your
						{GAME_NAME} data.{" "}
						<a href="https://bugs.chromium.org/p/chromium/issues/detail?id=340821">
							This is true even if you tell it to only delete data from today -
							if you played {GAME_NAME} at all today, it will completely delete
							all your leagues.
						</a>{" "}
