...
const getPlayerStats = (
	...
	// Filtering, merging, and stat calculations only read the source rows.
	// Copy nested values after selecting the requested output stats below.
...
const processPlayerStats = (
	...
	// Most requests return only numbers. Copy arrays/objects that are actually
	// returned (for example, game highs and fielding stats), not every input stat.
