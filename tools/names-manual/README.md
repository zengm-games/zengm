...
For names that are used in multiple countries (like Hispanic names) do the same thing, except replace "country" in the filename with "group". Some of these are automatically generated by the `../names-groups.ts` script.
